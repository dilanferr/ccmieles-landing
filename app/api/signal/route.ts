...
/**
 * Endpoint de tracking de primera parte (nombre neutro para no ser bloqueado
 * por adblockers/Brave/uBlock, que sí bloquean rutas con "track"/"analytics").
 ...
 * Falla en silencio (no rompe el sitio).
 *
 *   POST /api/signal
